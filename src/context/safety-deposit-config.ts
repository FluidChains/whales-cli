 ...
 */
 ...
 import {
   ...
   TupleNumericType,
   Borsh,
 } from '../sdk/programs/core';
 import { Buffer } from 'buffer';
import { MetaplexKey, MetaplexProgram } from '../sdk/programs/plex/MetaplexProgram';
import { METAPLEX_ID } from '../ids';
 ...
 export class ValidateSafetyDepositBoxV2 extends Borsh.Data<ValidateSafetyDepositBoxV2Args> {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    static readonly SCHEMA: Map<any, any> = new Map([
    ...
    constructor(args: ValidateSafetyDepositBoxV2Args) {
        super(args);
        this.instruction = new BN(19);
      }
