import { Borsh, Transaction, StringPublicKey } from '../core';
import {
  PublicKey,
  SystemProgram,
  SYSVAR_RENT_PUBKEY,
...
import { PriceFloor } from './Auction';
...
export class CreateAuctionV2 extends Transaction {
  constructor(options: TransactionBlockhashCtor, params: CreateAuctionV2Params) {
    super(options);
